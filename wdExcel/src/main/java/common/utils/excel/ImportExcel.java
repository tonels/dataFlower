...
public class ImportExcel {
    ...
    public <E> List<E> getDataList(Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException {
        return getDataList(null, cls, groups);
    }

    public <E> List<E> getDataList(AbstractDictUtils dictUtils, Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException {
                ...
                if (val != null) {
                    ...
                    try {
                        if (valType == String.class) {
                            ...
                            Date temp = DateUtil.getJavaDate((Double) val);
                            val = temp.toInstant().atZone(ZoneOffset.ofHours(8)).toLocalDateTime();
                        } else if (valType == LocalDate.class) {
                            Date temp = DateUtil.getJavaDate((Double) val);
                            val = temp.toInstant().atZone(ZoneOffset.ofHours(8)).toLocalDate();
                        } else {
