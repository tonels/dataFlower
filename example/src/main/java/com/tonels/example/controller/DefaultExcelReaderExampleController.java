 ...
 */
package com.tonels.example.controller;

import com.tonels.example.pojo.ArtCrowd;
...
public class DefaultExcelReaderExampleController {
    ...
    public List<ArtCrowd> read() throws Exception {
        ...
        result.stream().map(e -> e.getAssessmentTime()).collect(Collectors.toList()).forEach(System.out::println);
        return result;
    }
